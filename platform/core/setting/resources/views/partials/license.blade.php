...
<v-license-form id="license-form" verify-url="{{ route('settings.license.verify.index') }}"
                ...
                v-slot="{ initialized, loading, verified, license, deactivateLicense, resetLicense }" v-cloak>
